...
public @interface PagePublishSchedulerConfig {
    ...
    String scheduler_expression() default "0 0/1 * * * ?"; // default: every day at 12 PM

    @AttributeDefinition(
            name = "Root Page Path",
            description = "Root page path under which pages will be published (e.g. /content/we-retail/en)",
            type = AttributeType.STRING
    )
